...
assert 'NBmodel.txt' in os.listdir(f'/w261_personal/Assignments/HW2/.'), "ERROR: can't find NBmodel.txt"

# load the model into a dictionary for easy access
MODEL = {}
for record in open('/w261_personal/Assignments/HW2/NBmodel.txt', 'r').readlines():
...
for line in sys.stdin:
    ...
    #pull priors and 
    ham_prior, spam_prior = MODEL.get("ClassPriors", (0,0))
    ...
    print(f"{docID}\t{_class}\t{ham_model_result}\t{spam_model_result}\t{pred_class}")